...
sds parse_bulk(sds input, const char* end, resp_object* obj);
...
sds parse_array(sds input, const char* end, resp_object* obj);
sds handle_type(sds input, const char* end, char type, resp_object* obj);
